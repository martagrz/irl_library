...
def run_optimal(env, n_rows, n_cols, n_steps, n_demos, mdp_solver, show=False):
    ...
    plot_quiver(n_rows, n_cols, optimal_policy, show=show)
    plot_reward_surface(n_rows, n_cols, opt_reward_vector, show=show)
...
def run_algo(demonstrations, n_rows, n_cols, algo, name, train=True, show=True):
    ...
    plot_quiver(n_rows, n_cols, learned_policy, show=show)
    plot_reward_surface(n_rows, n_cols, rewards_vector, show=show)
    print("Done.")
